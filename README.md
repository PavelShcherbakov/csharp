...
| [Builder](/Creational/Builder/Builder.md) | Builds a complex object using simple objects | ✘ |
| [Factory Method](/Creational/Factory%20method/FactoryMethod.md) | Defers instantiation of an object to a specialized function for creating instances | ✘ |
| [Prototype](/Creational/Prototype/Prototype.md) | It is used when the type of objects to create is determined by a prototypical instance, which is cloned to produce new objects | ✘ |
| [Singleton](/Creational/Singleton/Singleton.md) | Restricts instantiation of a type to one object | ✘ |
| [Object Pool](/Creational/Object%20pool/ObjectPool.md) | Instantiates and maintains a group of objects instances of the same type | ✘ |
